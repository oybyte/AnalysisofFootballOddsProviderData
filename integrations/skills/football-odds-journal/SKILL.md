...
description: Operate this repository's governed football match workflow. Use when an agent needs to archive a user's match analysis long-form text, live update, correction, result, "完赛：", "赛果", "比赛结束", "复盘：" or postmatch material; extract evidence; prepare an analysis; retrieve cases; validate or lock conclusions; or process match results in AnalysisofFootballOddsProviderData.
---
