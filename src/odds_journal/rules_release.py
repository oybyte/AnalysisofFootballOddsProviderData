                ...
                try:
                    ...
                    if version == "2.0.0":
                        required_paths = {
                            ...
                            "src/odds_journal/knowledge_engine/application/run_ai_advisory.py",
                            "src/odds_journal/knowledge_engine/application/analytics.py",
                            "src/odds_journal/knowledge_engine/application/study_report.py",
                            "src/odds_journal/knowledge_engine/application/release_evidence.py",
                            ...
                            "src/odds_journal/knowledge_engine/adapters/study_ledger.py",
                            "src/odds_journal/knowledge_engine/adapters/official_baseline.py",
                            ...
                            "src/odds_journal/knowledge_engine/domain/contract_v9.py",
                            "src/odds_journal/knowledge_engine/domain/release_evidence.py",
                            "schemas/ruleset.schema.json",
                            "schemas/analysis-receipt.schema.json",
                            "tests/knowledge_engine/test_functional.py",
                            "tests/knowledge_engine/test_closure_plan.py",
                        }
