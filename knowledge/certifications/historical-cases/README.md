...
截至 2026-08-04，20 场队列中已有 3 场认证通过：`legacy-gimcheon-daejeon`、`legacy-seoul-ulsan`、`legacy-incheon-bucheon`。其余 17 场保持 `pending`，需先按 [preflight-2026-08-02.md](preflight-2026-08-02.md) 补齐证据；不得因历史复盘或赛果存在而直接转正。认证仅开放离线规则回归资格，不会生成锁定、结算、正式复盘，也不改变活动 `football-analysis@1.5.0`。
