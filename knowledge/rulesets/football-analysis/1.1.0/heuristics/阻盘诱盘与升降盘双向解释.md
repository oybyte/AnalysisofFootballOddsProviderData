...
source_atom_ids:
- doubao-2026-07-28-text-a00153
- doubao-2026-07-28-text-a00242
...
升降盘可能是信息重估，也可能是热度与风险管理，必须结合前置历史。
...
- 假设 A：升盘站稳且跨市场同步，真实支持权重上升。
- 假设 B：升盘突击、反复或回撤，热度吸收权重上升。
...
- source_atom_id: `doubao-2026-07-28-text-a00153`；claim_id: `claim-doubao-2026-07-28-text-a00153`
- source_atom_id: `doubao-2026-07-28-text-a00242`；claim_id: `claim-doubao-2026-07-28-text-a00242`
